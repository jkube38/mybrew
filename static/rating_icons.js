            ...
            if (hop === 1) {
                ...
                hopFunctions.push(
                    this[`hop${hop}${brewery}Hover`] = () => {
                        ...
                        oneHop.style.backgroundImage = "url('/media/images/green_hop.png')"
                    ...
                    this[`hop${hop}${brewery}Exit`] = () => {
                        ...
                        let oneHop = document.getElementById(`rate${hop}${brewery}`)
                        oneHop.style.backgroundImage = "url('/media/images/white_hop.png')"
                ...
                hopFunctions.push(
                    this[`hop${hop}${brewery}Hover`] = () => {
                        ...
                        oneHop.style.backgroundImage = "url('/media/images/green_hop.png')"
                        twoHop.style.backgroundImage = "url('/media/images/green_hop.png')"
                    ...
                    this[`hop${hop}${brewery}Exit`] = () => {
                        ...
                        let twoHop = document.getElementById(`rate${hop}${brewery}`)
                        oneHop.style.backgroundImage = "url('/media/images/white_hop.png')"
                        twoHop.style.backgroundImage = "url('/media/images/white_hop.png')"
                ...
                hopFunctions.push(
                    this[`hop${hop}${brewery}Hover`] = () => {
                        ...
                        oneHop.style.backgroundImage = "url('/media/images/green_hop.png')"
                        twoHop.style.backgroundImage = "url('/media/images/green_hop.png')"
                        threeHop.style.backgroundImage = "url('/media/images/green_hop.png')"
                    ...
                    this[`hop${hop}${brewery}Exit`] = () => {
                        ...
                        oneHop.style.backgroundImage = "url('/media/images/white_hop.png')"
                        twoHop.style.backgroundImage = "url('/media/images/white_hop.png')"
                        threeHop.style.backgroundImage = "url('/media/images/white_hop.png')"
                ...
                hopFunctions.push(
                    this[`hop${hop}${brewery}Hover`] = () => {
                        ...
                        twoHop.style.backgroundImage = "url('/media/images/green_hop.png')"
                        threeHop.style.backgroundImage = "url('/media/images/green_hop.png')"
                        fourHop.style.backgroundImage = "url('/media/images/green_hop.png')"
                    ...
                    this[`hop${hop}${brewery}Exit`] = () => {
                        ...
                        twoHop.style.backgroundImage = "url('/media/images/white_hop.png')"
                        threeHop.style.backgroundImage = "url('/media/images/white_hop.png')"
                        fourHop.style.backgroundImage = "url('/media/images/white_hop.png')"
                ...
                hopFunctions.push(
                    this[`hop${hop}${brewery}Hover`] = () => {
                        ...
                        threeHop.style.backgroundImage = "url('/media/images/green_hop.png')"
                        fourHop.style.backgroundImage = "url('/media/images/green_hop.png')"
                        fiveHop.style.backgroundImage = "url('/media/images/green_hop.png')"
                    ...
                    this[`hop${hop}${brewery}Exit`] = () => {
                        ...
                        threeHop.style.backgroundImage = "url('/media/images/white_hop.png')"
                        fourHop.style.backgroundImage = "url('/media/images/white_hop.png')"
                        fiveHop.style.backgroundImage = "url('/media/images/white_hop.png')"
